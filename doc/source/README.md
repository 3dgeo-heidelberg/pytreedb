...
An example tree is given in [data/geojson/AbiAlb_BR03_01.geojson](https://github.com/3dgeo-heidelberg/pytreedb/blob/main/data/geojson/AbiAlb_BR03_01.geojson) and the GeoJSON template for tree objects is defined here [pytreedb/db_conf.py](https://github.com/3dgeo-heidelberg/pytreedb/blob/main/pytreedb/db_conf.py).
...
[<img src="https://raw.githubusercontent.com/3dgeo-heidelberg/pytreedb/main/doc/_static/dfg_logo_englisch_blau_en.gif" width="30%">](https://www.dfg.de/en/)
