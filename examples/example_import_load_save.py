...
print("# Fresh import data from into pytreedb from URL which provides zipped folder with geojson files of each tree "
      "to be added")
mydb.import_data(r'https://github.com/3dgeo-heidelberg/pytreedb/raw/main/data/test/geojsons.zip', overwrite=True)
...
mydb.import_db('https://github.com/3dgeo-heidelberg/pytreedb/raw/main/data/test/data.db', overwrite=True)
print(mydb.get_stats())
...
print("# Show how to use a pytreedb util function: Generate SHA-1 hash for a file "
